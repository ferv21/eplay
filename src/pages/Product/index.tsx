    ...
    <>
      ...
      <Section title="Sobre o jogo" background="black">
        <p>
          ...
          destruir o mundo bruxo. Faça aliados, lute contra bruxos das trevas e
          decida o destino do mundo bruxo. Seu legado é o que você faz dele.
          Viva o Inesperado.
        </p>
      </Section>
      <Section title="Mais detalhes" background="grey">
        <p>
          ...
          <b>Idiomas:</b> O jogo oferece suporte a diverso idiomas, incluindo
